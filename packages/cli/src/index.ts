...
/**
 * @minions-test-observability/cli — CLI for Minions Test-observability
 *
...
import { customTypes } from '@minions-test-observability/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Test-observability'));
        console.log(chalk.dim('Trace capture, tool call logs, reasoning timings, and latency breakdowns'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-test-observability/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-test-observability/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-test-observability')}`);
